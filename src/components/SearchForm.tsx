    ...
    <form action="/search" method="GET" role="search" className={className}>
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          placeholder="Search Louisiana stories..."
          className="w-full rounded-full border border-[#D8E1E5] bg-white px-4 py-2 text-sm text-[#263238] placeholder:text-[#66737B] focus:border-[#2287C9] focus:outline-none focus:ring-2 focus:ring-[#2287C9]/40"
        />
        <button
          type="submit"
